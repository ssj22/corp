...
function checkPwd() {
	...
	if (pwd != cpwd) {
		alert("Passwords don't match. Enter the same password in both fields");
...
<body>
<div align="center">
<form id="login" action="reg" method="POST">
    <h1>Log In</h1>
    <fieldset id="inputs">
        <input id="username" name="username" type="text" placeholder="Select Username" autofocus required>   
        ...
        <input id="desig" name="desig" type="text" placeholder="Enter Designation" required>
    </fieldset>
    <fieldset id="actions">
